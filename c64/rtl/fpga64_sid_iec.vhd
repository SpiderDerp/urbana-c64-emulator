...
port(
	...
	-- external keyboard matrix (replaces fpga64_keyboard)
	ext_kbd_pai : in  unsigned(7 downto 0);
	ext_kbd_pao : out unsigned(7 downto 0);
	ext_kbd_pbi : in  unsigned(7 downto 0);
	ext_kbd_pbo : out unsigned(7 downto 0);

	-- legacy ps2 (unused on urbana)
	ps2_key     : in  std_logic_vector(10 downto 0) := (others => '0');
	kbd_reset   : in  std_logic := '0';
	shift_mod   : in  std_logic_vector(1 downto 0) := "00";
...
-- -----------------------------------------------------------------------
-- keyboard matrix driven externally (c64_hid_matrix in sv top)
-- -----------------------------------------------------------------------
ext_kbd_pai <= cia1_pao;
ext_kbd_pbi <= cia1_pbo;
cia1_pai    <= ext_kbd_pao;
cia1_pbi    <= ext_kbd_pbo;
freeze_key  <= '0';
tape_play   <= '0';
mod_key     <= '0';
