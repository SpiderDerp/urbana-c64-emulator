...
# generated clocks (adjust cell paths after synthesis if needed)
# create_generated_clock -name clk_25m -source [get_pins clk_wiz_hdmi/inst/clk_in1] -multiply_by 0.25 [get_pins clk_wiz_hdmi/inst/clk_out1]
# create_generated_clock -name clk_c64  -source [get_pins clk_wiz_c64_i/inst/clk_in1] -multiply_by 0.31527956 [get_pins clk_wiz_c64_i/inst/clk_out1]

set_clock_groups -asynchronous -group [get_clocks clk_100] -group [get_clocks -of_objects [get_pins -hierarchical -filter {NAME =~ *clk_wiz*clk_out*}]]
